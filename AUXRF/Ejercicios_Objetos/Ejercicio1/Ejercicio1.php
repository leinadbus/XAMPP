...
<body>
    ...
    $publisher1= new Publisher(0001,"Rafa","Calle Marclino Orozco 24",619866709,"www.google.com");
    $publisher2 = new Publisher(0002,"Hamza","Calle de su prima",685321685,"facebook.com");

    $book1 = new Book(20,"asdasd",123123,"dasdasda",234,100,$publisher1);
    
    $magazine1 = new Magazine("Pagina WEB",123123,"dasdasda",234,100,$publisher2);
